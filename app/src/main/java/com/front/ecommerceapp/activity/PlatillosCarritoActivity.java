...
import com.front.ecommerceapp.adapter.PlatilloCarritoAdapter;
import com.front.ecommerceapp.communication.CarritoCommunication;
...
public class PlatillosCarritoActivity extends AppCompatActivity implements CarritoCommunication {
    ...
    private void init(){
        ...
        btnFinalizarCompra.setOnClickListener(v -> {
            //trayendo la sesión del usuario
    ...
    private void registrarPedido(int idC){
        ...
        //llamando el id que esta en sesión
