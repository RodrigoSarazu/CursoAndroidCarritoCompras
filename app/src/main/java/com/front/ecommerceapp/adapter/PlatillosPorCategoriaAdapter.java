...
public class PlatillosPorCategoriaAdapter extends RecyclerView.Adapter<PlatillosPorCategoriaAdapter.ViewHolder> {
    private List<Platillo>listaPlatillosPorCategoria;

    public PlatillosPorCategoriaAdapter(List<Platillo> listaPlatillosPorCategoria) {
        this.listaPlatillosPorCategoria = listaPlatillosPorCategoria;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.setItem(this.listaPlatillosPorCategoria.get(position));
    }

    @Override
    public int getItemCount() {
        return this.listaPlatillosPorCategoria.size();
    }

    //Método Update Items
    public void updateItems(List<Platillo>platillosByCategoria){
        this.listaPlatillosPorCategoria.clear();
        this.listaPlatillosPorCategoria.addAll(platillosByCategoria);
