...
public class ConfigApi {
    //10.0.2.2 - ip de android
    public static final String baseUrlE="http://192.168.1.9:9595";
    ...
    private static void initClient() {
        Gson gson=new GsonBuilder()
                ...
                .create();
        retrofit=new Retrofit.Builder().baseUrl(baseUrlE)
    ...
    //hasta aquí se va a realizar peticiones
    ...
    //llamando a la clase de CategoriaApi
